...
`);
    ...
    try {
        ...
        console.log('Database migration: Added auto_replies.template_id column');
    } catch (e) {
        // Column already exists
    }
    ...
    try {
        ...
        console.log('Database migration: Added scheduled_messages.template_id column');
    } catch (e) {
        // Column already exists
    }
    ...
    return { db, messages, chats, autoReplies, scheduled, messageTemplates, webhooks, scripts, scriptLogs, logs, maintenance };
}
